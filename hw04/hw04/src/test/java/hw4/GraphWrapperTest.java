...
public class GraphWrapperTest {
	...
	// Compare Edge **********************************************************************************************************************************
	@Test
	public void compareEdge1() {
		int comp = 0;
		
		Edge e1 = new Edge("A", "B", 3);
		Edge e2 = new Edge("A", "B", 3);
	...
	// Num Edges **********************************************************************************************************************************
	@Test
	public void numEdges1() {
		Graph g1 = new Graph();
		Edge<String, String> edge = new Edge<String, String>("A", "A", "A");
		int edges = 0;
		...
		assertEquals("wrong edge value " + edges, edges, 1);
